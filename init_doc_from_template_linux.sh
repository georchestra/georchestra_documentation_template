...
TARGET_READTHEDOCS_DOC_EN="${SCRIPT_DIR}/readthedocs_EN.md"
TARGET_READTHEDOCS_DOC_FR="${SCRIPT_DIR}/readthedocs_FR.md"
...
TEMPLATE_READTHEDOCS_DOC_EN="${CLONE_DIR}/readthedocs_EN.md"
TEMPLATE_READTHEDOCS_DOC_FR="${CLONE_DIR}/readthedocs_FR.md"
...
cp -a "${TEMPLATE_READTHEDOCS_DOC_EN}" "${TARGET_READTHEDOCS_DOC_EN}"
echo "Copied readthedocs_EN.md"
cp -a "${TEMPLATE_READTHEDOCS_DOC_FR}" "${TARGET_READTHEDOCS_DOC_FR}"
echo "Copied readthedocs_FR.md"
